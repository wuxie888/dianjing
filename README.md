...
<table>
  <tr>
    <td width="50%" valign="top">
      <img src="./assets/readme/before-readme.png" alt="改造前：Hero 下方回到普通说明书式 README" width="100%">
      <br>
...
<a href="./skills/dianjing/SKILL.md">
  <img src="./assets/readme/workflow.png" alt="点睛四步工作流：Audit、Position、Compose、Verify" width="100%">
</a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <a href="https://wuxie888.github.io/dianjing/"><img src="./assets/readme/pages-hero.png" alt="GitHub Pages 产品首页" width="100%"></a>
      <br><sub><b>产品首页</b> · 定位、品牌和主叙事</sub>
    </td>
    <td width="50%" valign="top">
      <img src="./assets/readme/levels.png" alt="点睛四级装修系统" width="100%">
      <br><sub><b>装修系统</b> · 从基础门面到发布级产品仓库</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <img src="./assets/readme/verification.png" alt="点睛公开验收原则" width="100%">
      <br><sub><b>公开验收</b> · 真实状态按证据表达</sub>
    </td>
    <td width="50%" valign="top">
      <img src="./assets/readme/install.png" alt="点睛安装与首次使用页面" width="100%">
...
<img src="./assets/readme/levels.png" alt="点睛四级装修系统：L1 基础门面、L2 动态 README、L3 动态产品仓库、L4 发布级门面" width="100%">
...
<img src="./assets/readme/verification.png" alt="点睛验收清单：仓库边界、真实截图、安装、减少动态、源码 Pages 与 Release" width="100%">
